...
AnsSet.register(idx, group=group, label='a \(P_{\\rm bub}\)', value=np.round(Pbub,2), units='kPa', formatter='{:.2f}')
AnsSet.register(idx, group=group, label='b \(P_{\\rm dew}\)', value=np.round(Pdew,2), units='kPa', formatter='{:.2f}')
AnsSet.register(idx, group=group, label='c \(x_{\\rm az}\)', value=np.round(xazeo,4), formatter='{:.4f}')
AnsSet.register(idx, group=group, label='c \(P_{\\rm az}\)', value=np.round(Pazeo,2), units='kPa', formatter='{:.2f}')
...
not showing full $Pxy$ diagram for this binary at \py{f'{T:.2f}'} K yet
}
