...
# register answers
AnsSet.register(qno, group=group, label=r'\(X_{\rm eq}\)', value=mock.Xeq[0], formatter='{:.5f}')
for y, c in zip(mock.ys, components):
    AnsSet.register(qno, group=group, label=rf'\(y_{{\rm {c.as_tex()}}}\)', value=y, formatter='{:.5f}')
\end{pycode}
